...
public:
  explicit GenerateTask(nav_msgs::msg::Path path, QVector<int> modeTypes, QString _fileStoragePath, QWidget *parent = nullptr);  //构造函数中_fileStoragePath参数应传递地图文件(yaml文件)的完整路径(比如"/home/xxx/map/map1.yaml")
  static void saveTaskToFile(nav_msgs::msg::Path, QVector<int> modeTypes, QString, QWidget *parent = nullptr, const QString &title = QString("Generate Task"));
