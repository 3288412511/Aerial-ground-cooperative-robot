...
private:
  ...
  QHash<QString, int> MsgTypeHash{
    {"sensor_msgs/msg/LaserScan", AddLayer::laserscan},
    {"sensor_msgs/msg/PointCloud2", AddLayer::pointcloud2},
    {"nav_msgs/msg/OccupancyGrid", AddLayer::map},
    {"nav_msgs/msg/Path", AddLayer::path},
    {"geometry_msgs/msg/PointStamped", AddLayer::pointstamped},
    {"visualization_msgs/msg/Marker", AddLayer::marker},
    {"visualization_msgs/msg/MarkerArray", AddLayer::markerarray}
  };
...
protected:
  void topicListAppendByTopicInfo(const std::string& name, const std::string& datatype);
};
